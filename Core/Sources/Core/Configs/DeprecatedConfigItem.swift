...
extension Config.Deprecated {
    ...
    struct TypeCommaAndPeriod: BoolConfigItem {
        ...
        static let key: String = "dev.ensan.inputmethod.iroha.preference.typeCommaAndPeriod"
    }
    ...
    struct ZenzaiIntegration: BoolConfigItem {
        ...
        static let key: String = "dev.ensan.inputmethod.iroha.preference.enableZenzai"
    }
    ...
    struct EnableOpenAiApiKey: BoolConfigItem {
        static let `default` = false
        static let key: String = "dev.ensan.inputmethod.iroha.preference.enableOpenAiApiKey"
    }
}
