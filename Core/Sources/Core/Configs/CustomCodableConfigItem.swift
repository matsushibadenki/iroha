...
extension Config {
    ...
    public struct Learning: CustomCodableConfigItem {
        ...
        public static let key: String = "dev.ensan.inputmethod.iroha.preference.learning"
    }
}
...
extension Config {
    ...
    public struct UserDictionary: CustomCodableConfigItem {
        ...
        public static let `default`: Value = .init(items: [
            .init(word: "iroha", reading: "いろは", hint: "アプリ")
        ])
        public static let key: String = "dev.ensan.inputmethod.iroha.preference.user_dictionary_temporal2"
    }
    ...
    public struct SystemUserDictionary: CustomCodableConfigItem {
        ...
        public static let `default`: Value = .init(items: [])
        public static let key: String = "dev.ensan.inputmethod.iroha.preference.system_user_dictionary"
    }
}
...
extension Config {
    ...
    public struct ZenzaiPersonalizationLevel: CustomCodableConfigItem {
        ...
        public static let key: String = "dev.ensan.inputmethod.iroha.preference.zenzai.personalization_level"
    }
}
...
extension Config {
    public struct InputStyle: CustomCodableConfigItem {
        ...
        public static let key: String = "dev.ensan.inputmethod.iroha.preference.input_style"
    }
}
...
extension Config {
    ...
    public struct KeyboardLayout: CustomCodableConfigItem {
        ...
        public static let key: String = "dev.ensan.inputmethod.iroha.preference.keyboard_layout"
    }
    ...
    public struct AIBackendPreference: CustomCodableConfigItem {
        ...
        public static var `default`: Value {
            ...
            let legacyKey = "dev.ensan.inputmethod.iroha.preference.enableOpenAiApiKey"
        ...
        public static let key: String = "dev.ensan.inputmethod.iroha.preference.aiBackend"
    }
}
